        ...
        <div>
            <div id="about" className="flex flex-col items-center  m-2 rounded-md p-2 mb-8">
                <div className="flex flex-wrap justify-center m-5">
                    <h1 className="text-3xl md:text-5xl text-center font-semibold text-transparent bg-clip-text bg-gradient-to-br from-pink-500 to-purple-500 mb-4"> Welcome to my <br/> personal portfolio!</h1>
