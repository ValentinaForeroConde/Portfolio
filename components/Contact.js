        ...
        <div id="contact" className="flex flex-col align-center bg-pink-200 m-2 rounded-md">
            ...
            <div>
                <ul className="flex justify-center p-4">
                    ...
                    <li>
                        <a className="hover:text-pink-500 text-3xl p-2" href="https://contacts.google.com/person/c1690416318744411006?hl=es-419"><FontAwesomeIcon icon={faGoogle} /></a>
                    </li>
                    <li>
                        <a className="hover:text-pink-500 text-3xl p-2" href="https://www.linkedin.com/in/valentina-forero-conde-911936203/"><FontAwesomeIcon icon={faLinkedin} /></a>
                    </li>
                </ul>
            </div>
